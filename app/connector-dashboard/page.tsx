...
import { CheckCircle, Settings, Users, RefreshCw, AlertTriangle, ArrowLeft } from "lucide-react"
...
export default function ConnectorDashboard() {
  ...
  const handleSync = () => {
    toast({
      title: "Sync started",
      description: "Synchronization process has been initiated.",
      variant: "success",
    })
  }
  ...
  const handleRenewToken = () => {
    toast({
      title: "Token renewed",
      description: "Your OAuth token has been renewed successfully.",
      variant: "success",
    })
  }
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Breadcrumb className="mb-6">
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink>Connector Dashboard</BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="outline" size="sm" className="mt-2 flex items-center gap-1" onClick={handleSync}>
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="mt-4">
                            <Button size="sm" variant="outline" onClick={handleRenewToken}>
                              Renew Token
                            </Button>
                          </div>
                        </div>
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          toast({
                            title: "Users sync started",
                            description: "Synchronizing users between systems.",
                            variant: "success",
                          })
                        }}
                      >
                          ...
                          <td className="p-4 align-middle">
                            <Button
                              ...
                              onClick={() => {
                                toast({
                                  title: "User details",
                                  description: "Viewing details for John Doe",
                                  variant: "default",
                                })
                              }}
                            >
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          toast({
                            title: "Groups sync started",
                            description: "Synchronizing groups between systems.",
                            variant: "success",
                          })
                        }}
                      >
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-2">
                    ...
                    <Button style={{ backgroundColor: "#3ABCB8", borderColor: "#3ABCB8" }} onClick={handleSaveChanges}>
                      Save Changes
                    </Button>
                  </div>
                </div>
